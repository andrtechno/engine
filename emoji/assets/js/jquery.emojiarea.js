...
(function($, window, document) {
  ...
  */
  ...
  EmojiArea.createIcon = function(emoji, menu) {
    ...
    var className = emoji[3];
    
    
    var filename = $.emojiarea.spriteSheetPath ? $.emojiarea.spriteSheetPath : $.emojiarea.assetsPath + '/emoji.png';
   ...
   style += 'background:url(\'' + filename + '\') ' + xoffset + 'px ' + yoffset + 'px  no-repeat;';
  style += 'background-size:4100%;';
    ...
    EmojiArea.createIcon2 = function(emoji, menu) {
    ...
    return '<img src="' + blankGifPath + '" class="img emoji22'+className+'" style="'+ style + '" alt="' + util.htmlEntities(name) + '">';
  };
